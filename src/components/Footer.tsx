...
export function Footer() {
  return (
    <footer
      className="relative"
      style={{ background: '#0F172A', zIndex: 2 }}
    >
      {/* Wave top */}
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 md:px-10 lg:px-14 pt-12 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[14px] text-slate-400 leading-relaxed mb-6">
              Smart nutrition for real people. Track macros in seconds, not minutes.
            </p>
            <div className="flex gap-3">
              {/* App Store badge */}
              <a
                href="#"
                className="flex items-center gap-1.5 bg-white/8 hover:bg-white/12 transition-colors rounded-lg px-3 py-2 cursor-pointer"
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[13px] text-slate-500">
            © 2026 Trollii. All rights reserved.
          </p>
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[12px] text-slate-500">A.M.I. online · All systems operational</span>
          </div>
        </div>
      </div>
    </footer>
